        ...
        <div className="birthday-reveal relative z-10">
          ...
          <section id="letter" className="border-y border-[#f5eddf]/10 bg-[#120f18]/25 px-6 py-24 md:px-10 md:py-32">
            <div className="mx-auto grid max-w-[1180px] gap-12 md:grid-cols-[.65fr_1.35fr] md:gap-24">
              <div><p className="text-[10px] font-semibold uppercase tracking-[.3em] text-[#e7bd80]">01 · The letter</p><h2 className="birthday-serif mt-5 max-w-sm text-5xl leading-[.9] md:text-7xl">Words I would rather write by hand.</h2><p className="mt-8 text-sm leading-6 text-[#cdbcc9]">You can make this letter yours, too.</p></div>
